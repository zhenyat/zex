begin
  if (Coin.present? and not Coin.exist?)
    ...
    Coin.create name: 'Bitcoin Gold',     code: 'BTG',  kind: 'crypto'
    ...
    Coin.create name: 'Tether USD',       code: 'USDT', kind: 'crypto', unicode: "₮"
    Coin.create name: 'USD Coin',         code: 'USDC', kind: 'crypto'
